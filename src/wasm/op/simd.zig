...
/// SIMD operations use the 0xFD prefix followed by a multi-byte opcode
pub const V128 = enum(u32) {
    ...
    // v128 shuffle and swizzle
    i8x16_shuffle = 0x0D,
    i8x16_swizzle = 0x0E,

    // v128 splat operations
    i8x16_splat = 0x0F,
    i16x8_splat = 0x10,
    i32x4_splat = 0x11,
    i64x2_splat = 0x12,
    ...
    pub fn fromU32(val: u32) ?V128 {
        return std.enums.fromInt(V128, val);
    }
};
